...
package { 'cups-client':
  ensure => '1:1.6.3-40.el7',
}
package { 'cups-libs':
  ensure => '1:1.6.3-40.el7',
}
package { 'curl':
  ensure => '7.29.0-54.el7',
}
...
package { 'device-mapper':
  ensure => '7:1.02.158-2.el7',
}
package { 'device-mapper-libs':
  ensure => '7:1.02.158-2.el7',
}
package { 'dhclient':
  ensure => '12:4.2.5-77.el7.centos',
}
package { 'dhcp-common':
  ensure => '12:4.2.5-77.el7.centos',
}
...
package { 'e2fsprogs':
  ensure => '1.42.9-16.el7',
}
package { 'e2fsprogs-libs':
  ensure => '1.42.9-16.el7',
}
package { 'ec2-net-utils':
  ensure => '0.5-4.el7.centos',
}
package { 'ed':
  ensure => '1.9-4.el7',
}
...
package { 'iproute':
  ensure => '4.11.0-25.el7',
}
package { 'iptables':
  ensure => '1.4.21-33.el7',
}
package { 'iputils':
...
package { 'kpartx':
  ensure => '0.4.9-127.el7',
}
package { 'krb5-libs':
  ensure => '1.15.1-37.el7_7.2',
}
package { 'less':
  ensure => '458-9.el7',
}
...
package { 'linux-firmware':
  ensure => '20190429-72.gitddde598.el7',
}
package { 'locale':
  ensure => ['2.1.2'],
}
...
package { 'rsyslog':
  ensure => '8.24.0-41.el7_7',
}
package { 'ruby':
  ensure => '2.0.0.648-36.el7',
}
package { 'ruby-devel':
  ensure => '2.0.0.648-36.el7',
}
...
package { 'squid':
  ensure => '7:3.5.20-12.el7_6.1',
}
package { 'squid-migration-script':
  ensure => '7:3.5.20-12.el7_6.1',
}
package { 'stomp':
  ensure => ['1.3.3'],
